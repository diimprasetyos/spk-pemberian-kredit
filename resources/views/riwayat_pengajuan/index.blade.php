                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <p class="card-description">
                                Data Riwayat Pengajuan Kredit
                              </p>
                            <a href="{{route('riwayats.create')}}" class='mb-5 btn btn-primary'> <span
                                class='fa fa-plus'></span> Tambah Riwayat Pengajuan</a>
                                <a href="{{route('riwayats.print')}}" class='mb-5 btn btn-primary'> <span
                        ...
                        <table class="display nowrap table table-striped table-bordered">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>{{$r->status}}</td>
                                <td>
                                    <form action="{{ route('riwayats.destroy',$r->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <span data-toggle="tooltip" data-placement="bottom" title="Edit Data">
                                            <a href="{{ route('riwayats.edit',$r->id) }}"

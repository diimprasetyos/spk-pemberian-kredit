                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <p class="card-description">
                                ...
                                <a href="{{route('alternatives.create')}}" class='mb-5 btn btn-primary'> <span
                                    class='mdi mdi-plus'></span> Tambah Alternatif</a>
                                <a href="{{route('alternative.print')}}" class='mb-5 btn btn-primary'> <span
